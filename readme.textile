...
requirements become more and mor complex your code will become harder
...
as regular code not as asynchronous code. Regular AJAX style coding
is painful to unit test.
